...
interface GymuraCaseStudyMotionProps {
  locale: Locale;
  enabled: boolean;
  children: ReactNode;
}
...
/**
 * Scroll reveals for the Gymura case study only. Scoped to the article element;
 * does not animate every paragraph — key moments and section headings only.
 */
export function GymuraCaseStudyMotion({ locale, enabled, children }: GymuraCaseStudyMotionProps) {
